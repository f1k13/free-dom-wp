  ...
  <section class="section">
        <div class="container path__wrapper">
            <ul class="path__list">
                ...
                <li class="path__list-item"><a href="<?php echo get_site_url() ?>/bulding/">Обслуживание зданий
                и территорий</a></li>
            </ul>
        </div>
    </section>
    <section class="section header__main">
        <div class="container header__content-wrapper">
            <div class="header__content-left">
                <h2 class="header__content-title">Обслуживание зданий
и территорий</h2>
            ...
            <div class="main__services-cards">
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3  class="main__services-card-title">Уборка и вывоз снега</h3>
                ...
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3  class="main__services-card-title">Чистка крыш от снега</h3>
                        <p class="main-services__card-price">от 5000 ₽</p>
                        <div class="main__services-card-description">
                            <span class="main__services-card-text ">Описание Описание</span>
                            <span class="main__services-card-text">Описание Описание</span>
                ...
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3 class="main__services-card-title">Спил деревьев</h3>
                        <p class="main-services__card-price">от 5000 ₽</p>
                        <div class="main__services-card-description">
                            <span class="main__services-card-text ">Описание Описание</span>
                            <span class="main__services-card-text">Описание Описание</span>
