  ...
  <section class="section">
        <div class="container path__wrapper">
            <ul class="path__list">
                ...
                <li class="path__list-item"><a href="<?php echo get_site_url() ?>/roofing/">Кровельные работы</a></li>
            </ul>
        </div>
    </section>
            ...
            <div class="main__services-cards">
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3  class="main__services-card-title">ПВХ мембрана</h3>
                        ...
                        <button data-service="ПВХ мембрана" class="main__services-card-button">Заказать</button>
                    </div>
                    <img class="main__services-card-img" src="<?php bloginfo('template_url'); ?>/assets/images//roofing-img-1.png" alt="">
                </div>
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3 class="main__services-card-title">Наплавляемая</h3>
                        <p class="main-services__card-price">от 5000 ₽</p>
                        <div class="main__services-card-description">
                            <span class="main__services-card-text ">Описание Описание</span>
                            <span class="main__services-card-text">Описание Описание</span>
                        ...
                        <button data-service="Наплавляемая" class="main__services-card-button">Заказать</button>
                    </div>
                    <img class="main__services-card-img" src="<?php bloginfo('template_url'); ?>/assets/images//roofing-img-2.png" alt="">
                </div>
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3 class="main__services-card-title">Профнастил</h3>
                        <p class="main-services__card-price">от 5000 ₽</p>
                        <div class="main__services-card-description">
                            <span class="main__services-card-text ">Описание Описание</span>
                            <span class="main__services-card-text">Описание Описание</span>
                        ...
                        <button data-service="Профнастил" class="main__services-card-button">Заказать</button>
                    </div>
                    <img class="main__services-card-img" src="<?php bloginfo('template_url'); ?>/assets/images//roofing-img-3.png" alt="">
                </div>
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3 class="main__services-card-title">Металлочерепица</h3>
                        <p class="main-services__card-price">от 5000 ₽</p>
                        <div class="main__services-card-description">
                            <span class="main__services-card-text ">Описание Описание</span>
                            <span class="main__services-card-text">Описание Описание</span>
                        ...
                        <button data-service="Металлочерепица" class="main__services-card-button">Заказать</button>
                    </div>
                    <img class="main__services-card-img" src="<?php bloginfo('template_url'); ?>/assets/images//roofing-img-4.png" alt="">
                </div>
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3 class="main__services-card-title">Фальцевая</h3>
                        <p class="main-services__card-price">от 5000 ₽</p>
                        <div class="main__services-card-description">
                            <span class="main__services-card-text ">Описание Описание</span>
                            <span class="main__services-card-text">Описание Описание</span>
                        ...
                        <button data-service="Фальцевая" class="main__services-card-button">Заказать</button>
                    </div>
                    <img class="main__services-card-img" src="<?php bloginfo('template_url'); ?>/assets/images//roofing-img-5.png" alt="">
                </div>
            </div>
