  ...
  <section class="section">
        <div class="container path__wrapper">
            <ul class="path__list">
                ...
                <li class="path__list-item"><a href="<?php echo get_site_url() ?>/dismantling/">Демонтаж</a></li>
            </ul>
        </div>
    </section>
    <section class="section header__main">
        <div class="container header__content-wrapper">
            <div class="header__content-left">
                <h2 class="header__content-title">Демонтаж</h2>
            ...
            <div class="main__services-cards">
                <div class="main__services-card">
                    <div  class="main__services-card-left">
                        <h3  class="main__services-card-title">Демонтаж</h3>
                        ...
                        <button data-service="Демонтаж" class="main__services-card-button">Заказать</button>
                    </div>
