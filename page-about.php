...
<main>
    ...
    <section class="section">
        <div class="container about__wrapper">
            <h2 class="about-title">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget
                dolor. Aenean
                ...
                vel augue. Curabitur ullamcorper ultricies nisi.</h2>
        </div>
    </section>
</main>
<?php get_footer(); ?>